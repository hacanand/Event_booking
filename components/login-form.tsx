...
//         <h2 className="mt-6 text-3xl font-extrabold text-[#14144B]">Welcome to hiipitch</h2>
//         <p className="mt-2 text-sm text-gray-600">Sign in with LinkedIn to get started</p>
//       </div>
//       <RadioGroup
//         value={role}
