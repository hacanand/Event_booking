...
export function MeetingScheduledSuccess({ isOpen, onClose, date, time }: MeetingScheduledSuccessProps) {
  useEffect(() => {
    if (isOpen) {
      confetti({
        particleCount: 100,
        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              className="space-y-4"
            >
              <h2 className="text-3xl font-bold text-white">Meeting Scheduled!</h2>
