...
export default async function POST(req: any, res: any) {
  const refreshToken = req.cookies["calendly-refresh-token"];
  ...
  try {
    ...
    res.setHeader("Set-Cookie", [
      `calendly-access-token=${access_token}; HttpOnly; Path=/;`,
      `calendly-refresh-token=${refresh_token}; HttpOnly; Path=/;`,
      `calendly-token-expiry=${
